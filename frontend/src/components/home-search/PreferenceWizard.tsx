...
const steps = [
  { eyebrow: "Your place", title: "What kind of home feels like you?", options: [{ label: "Desert modern", icon: House }, { label: "Resort-style", icon: Palmtree }, { label: "Lock & leave", icon: Building2 }] },
  { eyebrow: "Your essentials", title: "What should we prioritize?", options: [{ label: "A pool", image: "/pool.png", icon: Waves }, { label: "Low-water landscaping", image: "/grass.png", icon: Trees }, { label: "Mountain views", icon: Mountain }] },
