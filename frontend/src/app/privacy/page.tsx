  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-12 sm:px-6">
      ...
      <p className="mt-6 text-muted">
        House Compass stores your calculator inputs locally in your browser session to display results, and — if
        you create an account — saves calculations and favorite cities you explicitly choose to save to your
